...
// Ogni layer riceve un nome per facilitare la lettura, che viene poi utilizzato nella matrice dei tasti qui sotto.
// Gli underscore (sottolineature) non significano nulla: puoi avere un layer chiamato STUFF o qualsiasi altro nome.
// I nomi dei layer non devono necessariamente avere la stessa lunghezza, ovviamente, e puoi anche ometterli
// completamente e utilizzare solo numeri.
...
/*
       ┌───┐   ┌───┬───┬───┬───┐ ┌───┬───┬───┬───┐ ┌───┬───┬───┬───┐ ┌───┬───┬───┐
       │Rst│   │Hom│VoD│VoU│Mut│ │Stp│Prv│Ply│Nxt│ │Mai│Hom│Cal│Sch│ │   │Rod│Tog│
       └───┘   └───┴───┴───┴───┘ └───┴───┴───┴───┘ └───┴───┴───┴───┘ └───┴───┴───┘
       ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┐ ┌───┬───┬───┐ ┌───┬───┬───┬───┐
       │   │   │   │   │   │   │   │   │   │   │   │Spd│Spi│       │ │Mod│   │   │ │   │   │   │   │
       ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─────┤ ├───┼───┼───┤ ├───┼───┼───┼───┤
...
*/
    ...
    [_FN]   = LAYOUT_iso(
                ...
                _______, GAME,    _______,                            _______,                            _______, MO(_FN), _______, _______, RGB_HUD, RGB_VAD,  RGB_HUI,           _______, _______
            ),
